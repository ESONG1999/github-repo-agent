...
from ..agents.agents import repo_structure_auditor, issue_parser, pull_requests_parser, repo_branch_reporter
...
def build_crew(owner: str, repo: str) -> Crew:
    ...
    return Crew(
        # agents = [repo_structure_auditor, issue_parser, pull_requests_parser, repo_branch_reporter],
        agents = [repo_structure_auditor, issue_parser],
        tasks = tasks, 
