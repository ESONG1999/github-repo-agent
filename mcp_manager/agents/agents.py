...
repo_structure_auditor = Agent(
    ...
    goal = "Analyze the folder and file structure of a Git repo and produce a markdown file tree with clickable links.",
    backstory = (
...
issue_parser = Agent(
    role = "Issue Parser",
    goal = "List issues in a Github repository",
    backstory = (
...
pull_requests_parser = Agent(
    role = "Pull Requests Parser",
